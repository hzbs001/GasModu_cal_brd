...
void DMA1_Channel1_IRQHandler(void)
{
	if(DMA_GetFlagStatus(DMA1_FLAG_TC1) != RESET)
	{
		...
		//setDmaCompleteFlag();
		updateADCValue(dma4adc[0],iconv);
		updateADCValue(dma4adc[1],iconv+16);
		...
		(iconv&0x01)?GPIO_SetBits(GPIOA,GPIO_Pin_0):GPIO_ResetBits(GPIOA,GPIO_Pin_0);
		(iconv&0x02)?GPIO_SetBits(GPIOA,GPIO_Pin_1):GPIO_ResetBits(GPIOA,GPIO_Pin_1);
		(iconv&0x04)?GPIO_SetBits(GPIOA,GPIO_Pin_2):GPIO_ResetBits(GPIOA,GPIO_Pin_2);
		(iconv&0x08)?GPIO_SetBits(GPIOA,GPIO_Pin_3):GPIO_ResetBits(GPIOA,GPIO_Pin_3);
			
		(iconv&0x01)?GPIO_SetBits(GPIOA,GPIO_Pin_4):GPIO_ResetBits(GPIOA,GPIO_Pin_4);
		(iconv&0x02)?GPIO_SetBits(GPIOA,GPIO_Pin_5):GPIO_ResetBits(GPIOA,GPIO_Pin_5);
		(iconv&0x04)?GPIO_SetBits(GPIOA,GPIO_Pin_6):GPIO_ResetBits(GPIOA,GPIO_Pin_6);
		(iconv&0x08)?GPIO_SetBits(GPIOA,GPIO_Pin_7):GPIO_ResetBits(GPIOA,GPIO_Pin_7);	
